...
//axois to contact to pinnata
//Handle store the image to pinata and through pinnata the file will be save in the pinnata
    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `a64b3df02a5af007db5d`,
            pinata_secret_api_key: `a552e2ca11ca841f26d22d26dd8e0a2b99492a997c2c25a820880dc7a2e9fc37`,
        ...
        alert("Unable to upload Evidence to Pinata");
      }
    }
    alert("Successfully Evidence Uploaded");
    setFileName("No Evidence selected");
    setFile(null);
  };
  //Retreive the images
  ...
  return (
    <div className="top">
      <form className="form" onSubmit={handleSubmit}>
        ...
        />
        <span className="textArea">Evidence: {fileName}</span>
        <br></br>
        <br></br>
